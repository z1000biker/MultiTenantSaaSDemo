...
class Config:
    """Base configuration"""
    SECRET_KEY = os.environ.get('SECRET_KEY') or 'INSECURE_DEV_KEY_CHANGE_IN_PRODUCTION'
    JWT_SECRET_KEY = os.environ.get('JWT_SECRET_KEY') or 'INSECURE_JWT_KEY_CHANGE_IN_PRODUCTION'
